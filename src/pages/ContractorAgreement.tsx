...
Настоящее Соглашение Независимого Исполнителя («Соглашение») заключается между Get4You Ltd. («Платформа»), зарегистрированной в Израиле, и Исполнителем, физическим лицом, проживающим в Израиле.
...
הסכם קבלן עצמאי זה ("ההסכם") נחתם בין Get4You Ltd. ("הפלטפורמה"), חברה המאוגדת בישראל, לבין הקבלן, יחיד, תושב ישראל.
