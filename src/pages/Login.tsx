      ...
      <div className="w-full max-w-md mx-auto px-4">
        ...
        <div className="space-y-3 mb-6">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 rounded-xl border border-border bg-card text-sm font-medium hover:bg-secondary transition-colors disabled:opacity-50"
          >
            ...
            {socialLoading === 'google' ? '...' : t('auth.continueGoogle')}
          </button>
          <button
            type="button"
          ...
          >
            ...
            {socialLoading === 'apple' ? '...' : t('auth.continueApple')}
          </button>
        </div>
